...
class AuditConsumerTest {
    ...
    void consume_success() throws Exception {
        EventEnvelope envelope = new EventEnvelope(
                "event-1", EventType.PAYMENT_APPROVED, "payment-1", "Payment", "trace-1",
        ...
        assertThat(saved.getEventType()).isEqualTo(EventType.PAYMENT_APPROVED);
    ...
    void consume_duplicate_stillAcks() throws Exception {
        EventEnvelope envelope = new EventEnvelope(
                "event-1", EventType.PAYMENT_APPROVED, "payment-1", "Payment", null,
