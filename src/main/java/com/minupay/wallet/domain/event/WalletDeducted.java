...
public class WalletDeducted extends AbstractDomainEvent {
    ...
    public WalletDeducted(Long walletId, Long userId, Money amount, String referenceId) {
        super();
    ...
    public String getEventType() {
        return EventType.WALLET_DEDUCTED.wireName();
    }
    ...
    public String getTopic() {
        return EventTopic.WALLET_DEDUCTED;
    }
